  ...
  return (
    <div className="ProjectSliderBg sliderBg Sliderborder relative mx-auto mt-10 w-[90%] p-8  max-2xl:w-4/5  max-xl:w-[90%]  max-md:hidden ">
      ...
      <button
        ...
        className="absolute left-[45%] top-full mt-8 -translate-y-1/2 rounded-full border border-solid border-neutral-500 bg-neutral-800 px-3 py-2 text-white shadow hover:border-neutral-300 max-xl:left-[43%] max-lg:left-[42%]"
      >
        &#8592;
      </button>
      <button
        onClick={goToNext}
        className="absolute right-[45%] top-full mt-8 -translate-y-1/2 rounded-full border border-solid border-neutral-500 bg-neutral-800 px-3 py-2 text-white shadow hover:border-neutral-300 max-xl:right-[43%] max-lg:right-[42%]"
      >
        &#8594;
      </button>
    </div>
