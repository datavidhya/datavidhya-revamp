  ...
  return (
    <section className="relative flex flex-col justify-center items-center mb-6">
      ...
      <Link href={"/"} className="z-0 md:z-10">
        {" "}
        <div
          className={` h-[37px] p-1 md:p-3 bg-white flex items-center justify-evenly rounded-[30px] mt-9 md:mt-[80px] mx-auto border-[0.6px] md:border border-[#2c2c2c]/22 md:border-[#2c2c2c] mb-4 z-10`}
        >
      ...
      <h1
        className={`font-bold text-2xl md:text-[61px] bg-white text-center leading-[120%] tracking-[-2%] text-[#333] mb-10 md:mb-4 z-0 md:z-10 ${inter.className}`}
      >
      ...
      <img
        className="p-3 mb-10 md:mb-32 z-10 bg-white"
