...
//             <motion.h1
//               variants={item}
//               className="relative max-w-full text-3xl font-bold leading-[1.2] text-[#333333] sm:text-4xl md:text-[44px] 2xl:text-[61px] md:leading-[100%] lg:text-[56px] my-0  md:my-6"
//             >
//               Unlock your
...
//               <motion.div
//                 variants={cardItem}
//                 className="w-full rounded-[20px] border  border-[#D7D7D7] bg-gradient-to-br from-neutral-50 to-neutral-100 p-4 sm:p-6 md:w-[45%] lg:w-[40%] 2xl:w-[50%] md:rounded-[28px] md:p-4 "
//               >
...
//               <motion.div
//                 variants={cardItem}
//                 className="w-full rounded-[20px] border border-[#D7D7D7] bg-[#FAFAFA] p-4 sm:p-6 max-md:w-[40%] md:w-[40%] 2xl:w-[50%] md:rounded-[28px] md:p-4 "
//               >
