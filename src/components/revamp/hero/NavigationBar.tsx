...
const NavigationBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 mx-auto mt-4 h-[56px] max-w-[687px] rounded-2xl border border-[#DBDBDB] bg-[#F0F0F07A]/50 px-4 shadow-sm backdrop-blur-sm md:px-8">
