...
const ProjectFeedbackCard: React.FC<ProjectFeedbackCardProps> = ({
  ...
  return (
    <div className="rounded-[28px] shadow-[0_15px_20px_-12px_rgba(0,0,0,0.25)] transition-transform duration-600 ease-in-out hover:[transform:perspective(1500px)_rotateY(18deg)] [transform:perspective(3000px)_rotateY(0deg)] ">
      <div className="w-[20rem] md:w-[25rem] rounded-[28px] border border-[#D7D7D7] p-4 md:p-6 shadow-sm">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3
                className={`font-semibold text-[#000000]  ${roboto.className}`}
              >
                {name}
              </h3>
