...
const TestimonyCard = ({ text, pfp, Name, position, companyName }: prop) => {
  return (
    <div className="w-[18rem] md:w-[22rem] p-5 my-3 rounded-2xl border-[1px] border-[#D7D7D7] flex flex-col justify-between hover:shadow-lg hover:bg-gradient-to-br from-purple-50 to-blue-50">
