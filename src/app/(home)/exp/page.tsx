...
//   const times = chapters?.map(() => "5 min") || []; // Replace with real time if available

//   return (
//     <div className="rounded-[2px] border border-b-0 border-[#D7D7D7] bg-white max-md:my-2.5">
//       <div
...
//           <p className="text-xs md:text-lg">{chapters?.length || 0} Sections</p>
//           <p className="text-xs md:text-lg hidden md:block">
//             {(chapters?.length || 0) * 5} Minutes
//           </p>
//         </div>
//       </div>
...
//           >
//             <div className="w-full pl-2 md:pl-12 rounded-b-[2px] px-4 pb-3 text-[14px] md:text-[16px] leading-6 md:leading-8 text-[#7C7C7C] shadow-md dark:bg-gray-100 space-y-3">
//               {isLoadingChapters ? (
//                 <div className="flex items-center gap-2 text-sm text-gray-500">
...
//                   const key = `${course.slug}-${chapter.id}`;
//                   const isDescLoading = loadingChapterDescriptions.has(key);
//                   const isOpenDesc = chapterDescriptions[key] !== undefined;
...
//                       </div>
//                       {isOpenDesc && (
//                         <div className="pl-6 pt-1 text-sm text-[#807A82]">
//                           {isDescLoading ? (
//                             "Loading description..."
//                           ) : (
//                             <div
